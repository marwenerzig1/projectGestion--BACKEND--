...
<article>
    <div>
      <h1 class="liste">Liste des comptes des Responsables RH : </h1> 
      <div id="recherchee">
        <form class="form-inline my-2 my-lg-0" action="{{route('employe.ChercherResponsableRH')}}" method="POST" enctype="multipart/form-data">
            @csrf 
            <input class="form-control mr-sm-2" name="nom_prenom" type="search" placeholder="Responsable RH ... " aria-label="Search">
      ...
      <div class="Ajouter">
        @if(session('id_RH') == -1 )
            <form class="form-inline my-2 my-lg-0" action="{{route('responsable_RH.AjouterResponsableRH')}}" method="POST" enctype="multipart/form-data">
                @csrf 
                <label class="tt">Ajouter Responsable RH :    </label> 
    ...
    <div class="container">
      <div class="row text-center">
            ...
            @else
            <br> 
            <h4 class="d">Il n'y a aucun Responsable RH ! </h4> 
            @endif 
</article>
